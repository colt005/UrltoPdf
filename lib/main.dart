...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future sendEmail() async {
    ...
    var urlf = controllerURL.text.toString().startsWith("http") ? controllerURL.text : "http://"+controllerURL.text;
    
    final response =
        await http.get(endpoint+"url="+urlf+"&apiKey="+apiKey.apikey+"&email="+controllerEmail.text);
  ...
  Future<void> downloadFile() async {
    ...
    try{
       ...
       print(dir.path);
       var filname = controllerFilename.text == ""?"url2pdf":controllerFilename.text;
        await dio.download(urlPath, "${dir.path}/${filname}.pdf",onReceiveProgress: (recd,total){
  ...
  Widget build(BuildContext context) {
        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              Text("Downloading File : ${widget.progressString}",style: TextStyle(
                color: Colors.white,
              ),)
            ],
          ),
              ...
              children: <Widget>[
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                      hintText: "URL", labelText: "Enter URL"),
                ),
                SizedBox(
                  height: 10,
                ),
    ...
    return Scaffold(
      ...
      body: widget.downloading?downloadingWidget:bodyWidget
    );
  }
}
